...
class MovieCreditFragment : Fragment(R.layout.people_credit_listing) {

    private val viewModel: MovieCreditViewModel by viewModel()
    ...
    private fun loadCredits() {
        ...
        viewModel.movieCredit(people.id).observe(viewLifecycleOwner) {
            data {
