...
fun MovieReviewContent(
    ...
    state.handle(
        success = {
            if(it.isEmpty()) {
                MovieEmptyState(
                    title = stringResource(id = com.vlv.movie.R.string.movie_empty_state_review),
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(16.dp)
                )
...
class MovieReviewContentPreviewProvider: PreviewParameterProvider<Response<List<Review>>> {
...
@PreviewLightDark
@Composable
fun MovieReviewContentPreview(
    @PreviewParameter(MovieReviewContentPreviewProvider::class) data: Response<List<Review>>
) {
    TheMovieDbAppTheme {
        BackgroundPreview {
            MovieReviewContent(
